...
(function() {
  jQuery(function() {
    return $('#fridge_ingredient_ingredient_name').autocomplete({
...
(function() {
  ...
  remove_fields = function(link) {
    ...
    return $(link).up(".fields").hide();
  };

  jQuery(function() {
    return $('#recipe_ingredient_ingredient_name').autocomplete({
...
(function() {
  jQuery(function() {
    ...
    return $('#recipe_ingredient_name').autocomplete({
