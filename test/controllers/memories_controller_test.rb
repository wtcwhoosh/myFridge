...
class MemoriesControllerTest < ActionController::TestCase
  ...
  test "should create memory" do
    assert_difference('Memory.count') do
      post :create, memory: { circle_id: @memory.circle_id, memory: @memory.memory, score: @memory.score, user_id: @memory.user_id }
    end
  ...
  test "should update memory" do
    patch :update, id: @memory, memory: { circle_id: @memory.circle_id, memory: @memory.memory, score: @memory.score, user_id: @memory.user_id }
    assert_redirected_to memory_path(assigns(:memory))
  end
